    ...
    Foundation.libs.topbar = {
        ...
        events: function (c) {
            ...
            e(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar", function (a) {
                ...
                if (d.breakpoint()) {
                    a.preventDefault();
                    var b = e(this), c = b.closest("[" + d.attr_name() + "]"), f = c.find("section, .top-bar-section"), g = (b.next(".dropdown").outerHeight(), b.closest("li"));
                ...
                a.preventDefault();
                var b = e(this), c = b.closest("[" + d.attr_name() + "]"), f = c.find("section, .top-bar-section"), g = (c.data(d.attr_name(!0) + "-init"), b.closest("li.moved")), h = g.parent();
