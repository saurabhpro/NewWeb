...
public class EmployeeHrnetDetails extends BasicEmployeeDetails {
     ...
     *
     * @param empId             The Employee Ids generated by Reval India for its employee [Unique for each employee in India]
     * @param name              The name of the Employee in Reval India
     * @param attendanceOfLeave The overall details of attendance record read from the Biometric File.
     *                          It has all day details of that particular month whose biometric file has been uploaded
     */
